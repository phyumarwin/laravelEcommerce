    ...
    <ul class="nav">
      ...
      <li class="nav-item">
        ...
        <div class="collapse" id="products">
          <ul class="nav flex-column sub-menu">
            <li class="nav-item"><a href="{{ url('admin/products/create') }}" class="nav-link">Add Product</a></li>
            <li class="nav-item"><a href="{{ url('admin/products') }}" class="nav-link">View Product</a></li>
          </ul>
        </div>
      </li>
      <li class="nav-item">
